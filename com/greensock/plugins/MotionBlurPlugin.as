 ...
 */
	public class MotionBlurPlugin extends TweenPlugin {
		...
		override public function set changeFactor(n:Number):void {
			...
			if (bounds.width + _blur.blurX * 2 > 6000) { //in case it's too big and would exceed the 2880 maximum in Flash
				_blur.blurX = (bounds.width >= 6000) ? 0 : (6000 - bounds.width) * 0.5;
			}
